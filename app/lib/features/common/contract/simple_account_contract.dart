...
class SimpleAccountContract extends DeployedContract {
  SimpleAccountContract(super.abi, super.address);
  static SimpleAccountContract create({required EthereumAddress address}) {
    return SimpleAccountContract(
      ContractAbi.fromJson(
          jsonEncode(simpleAccountContractAbi), 'simple_account_contract'),
      address,
    );
  }
