...
class EntryPointContract extends DeployedContract {
  EntryPointContract(super.abi, super.address);
  static EntryPointContract create() {
    return EntryPointContract(
      ContractAbi.fromJson(
          jsonEncode(entryPointContractAbi), 'entry_point_contract'),
